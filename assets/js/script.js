...
(async () => {
    ...
    fetch('http://worldtimeapi.org/api/timezone/Asia/Mumbai').then(response => response.json()),
    ...
    fetch('http://worldtimeapi.org/api/timezone/Africa').then(response => response.json()),
